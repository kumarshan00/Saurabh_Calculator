...
#   <!-- =======================================================
#   * Repository Name: saurabh_calculator
#   * CodeAuthor: Saurabh Pandey.
#   ======================================================== -->

import tkinter #Using Tkiner Module for GUI
from tkinter import * #Using * to import everything from tkinter
root=Tk() 
root.title("Thanku for using! @Saurabh_Calculator") #title name 
root.geometry("570x600+100+200") # area of calculator
root.resizable(False,False) #use for off the maximise option
root.configure(bg="#17161b") # for root background

#function for value print
equation=""
def show(value):
    global equation
    equation+=value
...
#function for clear/delete everything
def clear():
          global equation
          equation=""
          label_result.config(text=equation)
...
def calculate():
       ...
       if equation !="":
            try:
                ...
                result="Error! Wrong Value Inserted" #If user put wrong command then this condition will execute.
                equation=""
            label_result.config(text=result)

          

label_result=Label(root,width=25,height=2,text="",font=("arial",30)) #Output GUI View.
label_result.pack()

#Button Collection: Clear,shash,percentage,star/multiply
